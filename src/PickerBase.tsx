...
/**
 * Shared engine behind {@link DateRangePicker} and {@link DatePicker} —
 * not part of the public API.
 */
export const PickerBase = forwardRef<DateRangePickerRef, PickerBaseProps>(
  function PickerBase(props, ref) {
    const {
      onOpenChange,
      onBlur,
      months = 2,
    ...
    // Mirror for the imperative handle, so getValue() is correct even when
    // called synchronously after clear() (before React re-renders).
